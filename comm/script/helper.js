...
!function() {
    function e(e) {
        return null == e ? e + "" : "object" === (void 0 === e ? "undefined" : t(e)) || "function" == typeof e ? c[l.call(e)] || "object" : void 0 === e ? "undefined" : t(e);
    }
    function n(t) {
        return "function" === e(t);
    }
    ...
    function o(t) {
        var e, n;
        return !(!t || "[object Object]" !== l.call(t)) && (!(e = u(t)) || "function" == typeof (n = f.call(e, "constructor") && e.constructor) && s.call(n) === d);
    }
    function i(t, e) {
        var n, o = 0;
    ...
    function a() {
        var e, r, i, u, c, l, f = arguments[0] || {}, s = 1, d = arguments.length, p = !1;
        for ("boolean" == typeof f && (p = f, f = arguments[s] || {}, s++), "object" === (void 0 === f ? "undefined" : t(f)) || n(f) || (f = {}), 
        s === d && (f = this, s--); s < d; s++) if (null != (e = arguments[s])) for (r in e) i = f[r], 
        f !== (u = e[r]) && (p && u && (o(u) || (c = Array.isArray(u))) ? (c ? (c = !1, 
        l = i && Array.isArray(i) ? i : []) : l = i && o(i) ? i : {}, f[r] = a(p, l, u)) : void 0 !== u && (f[r] = u));
        return f;
    }
    var u = Object.getPrototypeOf, c = {}, l = c.toString, f = c.hasOwnProperty, s = f.toString, d = s.call(Object);
    ...
    module.exports = {
        ...
        _validPlate: function(t) {
            return this._valid(this._platePatten, t);
        },
        _validString: function(t) {
            return void 0 === (t = this.trim(t)) || null == t || "" == t || "undefined" == t || "null" == t ? "" : t;
        },
        payNameToType: function(t) {
            var e = t, n = -1;
            return "支付宝" === e || "支付宝当面付" === e ? n = 2 : "微信支付" === e ? n = 4 : "财付通支付" === e ? n = 5 : "肯德基礼品卡支付" === e ? n = 6 : "心意美食卡支付" === e ? n = 7 : "神钱包" === e ? n = 66 : "云闪付" === e && (n = 18), 
            n;
        },
        _qrCodeEnterStore: function(t, e) {
            if (!t) return !0;
            var n = getApp();
            if (e) return n.globalData.isPackage = 2 != e, !1;
            var r = t.split("_");
            if (!(r.length > 1)) return !0;
            var o = r[1].toUpperCase();
            return !(!o || -1 === o.indexOf("M") && -1 === o.indexOf("S")) || (n.globalData.isPackage = !0, 
            !1);
        },
        ...
        _canUseByVersion: function(t) {
            return !!getApp().compareVersion(getApp().globalData.SDKVersion, t);
        },
        noop: function() {},
        error: function(t) {
            throw new Error(t);
        ...
        trim: function(t) {
            return null == t || void 0 == t ? "" : (t + "").replace(p, "");
        },
        typeOf: e,
        isFunction: n,
        ...
        extend: a,
        union: function() {
            var e, r, i, a, u, c, l = arguments[0] || {}, f = 1, s = arguments.length, d = !1;
            ...
            l !== (a = e[r]) && (d && a && (o(a) || (u = Array.isArray(a))) ? (u ? (u = !1, 
            c = i && Array.isArray(i) ? i : []) : c = i && o(i) ? i : {}, l[r] = $.extend(d, c, a)) : void 0 === a || null === a || void 0 !== i && null !== i || (l[r] = a));
            return l;
        }
    };
}();